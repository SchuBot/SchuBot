...
> SchuBot is a Mixer (Twitch under development) bot with a twist. Featuring Chat, Currencies ,Alerts , Commands and much more.  

> The concept is that SchuBot allows you to have all features available on a single page without having to navigate to other pages to get access to what you need.  
...
![GitHub package.json version](https://img.shields.io/github/package-json/v/SchuBot/SchuBot)

![GitHub language count](https://img.shields.io/github/languages/count/SchuBot/SchuBot)

![GitHub last commit](https://img.shields.io/github/last-commit/SchuBot/SchuBot)

![GitHub repo size](https://img.shields.io/github/repo-size/SchuBot/SchuBot)

![GitHub issues](https://img.shields.io/github/issues/SchuBot/SchuBot)

![GitHub commit activity](https://img.shields.io/github/commit-activity/w/SchuBot/SchuBot)
